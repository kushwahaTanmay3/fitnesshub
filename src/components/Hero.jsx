...
<div id='home' className=' font-Anton w-full h-auto pt-30 pb-10 max-sm:pb-20 max-sm:pl-2 px-20 bg-[#ff6b35] flex  max-sm:flex-col gap-10 max-sm:gap-2  '>
  ...
  <motion.div
   ...
   viewport={{once:true}}
   className='text-gray-800 text-2xl w-auto h-auto flex-col  max-sm:pt-10 '>
   <h1 className='max-sm:m-5 m-10 max-sm:text-6xl text-8xl'> Transform </h1>
   <h1 className='max-sm:m-4 m-8 max-sm:text-4xl text-6xl'>Your Body</h1>
   <h1 className='max-sm:m-2 m-6 max-sm:text-3xl text-4xl'>Today</h1>
